...
const config = {
  ...
  database: {
    mongodb: {
      ...
      database: process.env.MONGODB_DATABASE || "pptrk_trx",
  ...
  supreme: {
    ...
    hashKey: "66D7FC53A561966AE4BAC3C71DBAABDF57CA6A70688860C45A8AD5A1042A578FDA5E622ACFE2E05FA046DE6944D52F9E3EDE5ADAECE7B50B6E2233782AC3E603",
